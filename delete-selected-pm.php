...
///////////////////DELETE THE MESSAGES BY SETTING COLUMN TO ""//////////////////////////////////////////////////////////////////////////////////////////////////////////////

///////////PDO QUERY////////////////////////////////////	
	
				$sql = "UPDATE privatemessage SET INBOX='' WHERE  USERNAME=?  AND SELECTION_STATUS=? ";
...
$data="<span class=black>(<span class=red>".$totalrows."</span>) message has been deleted successfully</span><a class=postusername href='getstdinboxdb'> Back to Your Inbox</a>";

else

$data="<span class=black>(<span class=red>".$totalrows."</span>) messages has been deleted successfully </span><a class=postusername href='getstdinboxdb'> Back to Your Inbox</a>";
...
<div class="wrapper">
	...
	echo "<a href='delete-selected-pm' title=>Delete Selected Inbox Messages</a> "  ;
