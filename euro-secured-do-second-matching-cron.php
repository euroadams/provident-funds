...
////////////CHECK FOR SECOND MATCH PERMISSION////////////////////////////////////
///////////PDO QUERY////////////////////////////////////	
	...
	if($stmt->rowCount()){
		...
		///////RESTRICT INVESTMENT RETURN MATCHING TO WEEKDAYS AT 6AM ONLY///////////////////////////////////////////////////
		...
		if($wkday_now != "sunday" && $wkday_now != "saturday" ){
			...
			if($am_pm_now == "am"){
				...
				/////////IF IS AM ENSURE INVESTMENT RETURN MATCHING DOES'NT OCCUR BEFORE 6AM//////////////////////////////////////				
				if($xhour_now == 09 ){
			...
			///////////////SEND INVESTMENT RETURN MATCHING NOTIFICATION TO ALL ADMINS/////////////////////////////////////////////////////////////
			//////////PDO QUERY////////////////////////////////////	
			...
			while($admin_rows = $stmt1->fetch(PDO::FETCH_ASSOC)){	
				...
				*/
				////////////SEND ADMINS EMAIL/////////////////////////////////////
						...
						$message = '<b style="color:#ff0000;">ATTENTION ALL ADMINISTRATORS</b><br/> AN INVESTMENT RETURN MATCHING HAS JUST OCCURED<h2 style="color:#ff0000">TIME OF MATCHING WAS: '.dateFormatStyle(time()).' </h2> ';
						 $to = $receiver_email;									 									 
